...
- Para analisar as supernovas, mais útil utilizar **curva de luz** ao invés de diagrama HR.
  ...
  - Através do espectro de estrelas, é possível deduzir a abundância de cada elemento no universo.
    - ![Tabela de abundância de cada elemento químico no Universo](image-62.png)
...
- Nucleossíntese estelar
  ...
  - Quando mais favoráveis a temperatura e pressõa do núcleo estelar, mais elementos mais pesados podem ser formados.
...
- Os braços espirais
- Massa da Galáxia
  - É possível estimar a massa do disco da Galáxia  pelas leis de Kepler e de Newton
  - Para distâncias maiores, usa-se **curvas de rotação**
- Matéria escura
  - Existência constatada apenas gravitacionalmente
- Centro da Galáxia
  - Existência de um buraco negro supermassivo
    - Há gás se movendo em alta velocidade, logo é necessário que o centro seja massivo para suportar o gás orbitando.
    - Como o centro é massivo e pequeno (muito denso), há indícios de haver um buraco negro.
